...
import { StockData, ValuationReportData } from '@/app/types'
import { Locale } from '@/app/services/i18n'
import { supabase } from '@/app/services/database/supabase-client'
import { canGenerateReport } from '@/app/services/database/supabase-auth'
...
export default function HomePage({ params }: PageProps) {
  ...
  // 使用认证上下文管理用户状态
  const { user: useAuthUser, loading: userLoading, signOut: authSignOut, forceUpdate: useAuthForceUpdate, refreshUserData } = useAuthContext()
