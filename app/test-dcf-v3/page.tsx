...
export default function TestDCFV3Page() {
  const [dcfParameters, setDcfParameters] = useState<DCFParametersV3>({
  ...
  const handleParametersChange = (parameters: DCFParametersV3) => {
    setDcfParameters(parameters)
    console.log('DCF参数已更新:', parameters)
  }

  const handleRecalculate = async (parameters: DCFParametersV3) => {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            参考Old School Value的界面设计，包含收入来源选择、参数调整、安全边际可视化和历史DCF表格
          </p>
        </div>
