    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p>This report is no longer available.</p>
        </div>
      </div>
    )
  }
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-amber-800 mb-4">
                    This is a preview version. The complete report includes detailed valuation analysis, 
                    investment recommendations, risk assessments, and comprehensive financial modeling.
                  </p>
