...
export default function TestCouponIsolated() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-8">Isolated Coupon Test</h1>
        ...
        <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4">
          ...
          <div className="text-sm text-gray-300 space-y-1">
            <p>• This test bypasses all components and uses direct API calls</p>
            <p>• Check console for detailed logs</p>
            <p>• If this works, the issue is in the component layer</p>
            <p>• If this fails, the issue is in the API layer</p>
          </div>
        </div>
      </div>
    </div>
